...
arrange(ip_igx_univar_good, pvalue) %>% dplyr::select(response, predictor, pvalue) %>% head(100)
# arrange(ip_igx_univar_good, pv_adj_global) %>% dplyr::select(response, predictor, pv_adj_global) %>% head(100)
